      ...
      <div className="d-flex flex-row align-items-start">
       ...
       {order.items.length? <div className="col-4 order p-3 m-2">
          ...
          <div className="d-flex flex-row justify-content-between p-2">
            ...
            <span className="billing-cost">Rs.{order.total_cost}</span>
          </div>
          <div className="d-flex flex-row justify-content-between p-2">
            <span className="billing-item">Shipping</span>
            <span className="billing-cost">Rs.{order.shipping_charges}</span>
          </div>
          <div className="d-flex flex-row justify-content-between p-2">
            <span className="billing-item">Discount ({order.discount_in_percent}%)</span>
            <span className="billing-cost">-Rs.{order.total_cost*order.discount_in_percent/100}</span>
          </div>
          <div className="d-flex flex-row justify-content-between p-2">
            <span className="billing-item fs-5">Total</span>
            <span className="billing-cost fs-5">Rs.{order.total_cost-order.total_cost*order.discount_in_percent/100+order.shipping_charges }</span>
          </div>

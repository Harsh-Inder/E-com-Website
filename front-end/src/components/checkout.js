        ...
        <div class="col-md-5 col-lg-4 order-md-last">
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              ...
              <span class="text-muted">Rs.{order.total_cost}</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <small class="text-muted">Shipping Charges</small>
              </div>
              <span class="text-muted">Rs.{order.shipping_charges}</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <small class="text-muted">Discount </small>
              </div>
              <span class="text-muted">-Rs.{order.total_cost*order.discount_in_percent/100}</span>
            </li>
           
           
            <li class="list-group-item d-flex justify-content-between">
              <span>Total (INR)</span>
              <strong>Rs.{order.total_cost - order.total_cost*order.discount_in_percent/100 + order.shipping_charges}</strong>
            </li>
          </ul>
